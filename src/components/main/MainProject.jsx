...
const projectListData = [
  {
    ...
    contents:["Vue로 진행되는 프로젝트이며, 컴포넌트 개발, 기능 개선, 차량 런칭, 이벤트, 임직원 사이트 수정 및 메뉴 개발 등 운영 업무를 수행하고 있습니다.","Vue를 활용하여 데이터 등 전체 다루지는 않고 마크업, 부분 기능에 대해 작업을 진행하고 새로운 데이터 추가 작업 관련은 개발팀에서 진행하고 있는 프로젝트입니다."],
    review:["100% 프론트엔드로 해야할 업무를 하고 있지는 않고 퍼블리셔에서 Vue를 조금 추가한 정도로 운영업무를 진행하고 있어서 아쉬움이 있습니다.","기존 만들어진 데이터를 참고하여 조금씩 활용을 하고 있고 점차적으로 개발팀에서 작업 영향도를 줄이고 저희쪽 영향도를 서로에게 도움이 되도록 기술을 배우고 있습니다."],
  },
  {
    title:"제네시스 (운영)",
